  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col justify-between min-h-[70vh]">
              ...
              <div className="mt-8 sm:mt-10 relative">
                ...
                <div
                  className={`transition-all duration-500 ease-in-out ${
                    isFormOpen
                      ...
                      : "opacity-100 translate-y-0 max-h-[160px] flex flex-col gap-4"
                  }`}
                >
                  <button
                    type="button"
                    ...
                    className="inline-flex items-center gap-3 text-[13px] sm:text-[14px] font-bold tracking-[2px] uppercase text-[#111111] hover:text-[#FF5722] border-b border-black/50 hover:border-[#FF5722] pb-1.5 w-fit group cursor-pointer text-left transition-colors"
                ...
                <div
                  className={`contact-form-box bg-[#EAE4DC] border border-[#111111]/30 rounded-none relative transition-all duration-500 ease-in-out overflow-hidden ${
                    isFormOpen
                      ? "opacity-100 translate-y-0 max-h-[600px] p-5 sm:p-6 pointer-events-auto shadow-sm"
                ...
                >
                  <div className="flex items-center justify-between mb-4 pb-2 border-b border-black/15 contact-form-divider">
                    <span
                      className="contact-header-title text-[11px] font-mono font-bold uppercase tracking-[1.5px] text-[#111111]"
                    >
                    ...
                    <button
                      ...
                      className="contact-close-btn text-[11px] font-mono font-bold uppercase tracking-wider text-black/70 hover:text-[#FF5722] cursor-pointer transition-colors"
                    >
                      [ CLOSE × ]
                    </button>
                  </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          className="contact-input w-full bg-[#F3EFE9] border border-black/35 px-3 py-2 text-[13.5px] text-[#111111] placeholder:text-black/35 focus:outline-none focus:border-[#FF5722] focus:ring-1 focus:ring-[#FF5722] transition-colors"
                          style={{ fontFamily: "'Inter', sans-serif" }}
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <textarea
                          ...
                          disabled={status === "loading" || isRevealLayer}
                          className="contact-textarea w-full bg-[#F3EFE9] border border-black/35 px-3 py-2 text-[13.5px] text-[#111111] placeholder:text-black/35 focus:outline-none focus:border-[#FF5722] focus:ring-1 focus:ring-[#FF5722] transition-colors resize-y min-h-[90px]"
                          style={{ fontFamily: "'Inter', sans-serif" }}
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-1 gap-3">
                        <button
                          type="button"
                          onClick={() => setIsFormOpen(false)}
                          className="contact-cancel-btn text-[11px] font-mono font-bold tracking-wider uppercase text-black/60 hover:text-black cursor-pointer transition-colors"
                        >
                          CANCEL
                        </button>
                        ...
                        <button
                          type="submit"
                          disabled={status === "loading" || isRevealLayer}
                          className="contact-submit-btn bg-[#111111] text-[#F3EFE9] px-5 py-2.5 text-[11px] sm:text-[11.5px] font-mono font-bold tracking-[2px] uppercase hover:bg-[#FF5722] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-colors flex items-center gap-2"
                        >
                          {status === "loading" ? (
                            <>
        ...
        <div
          className="pt-12 mt-12 border-t border-black/25 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 reveal"
