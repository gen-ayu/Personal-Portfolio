...
export default function ScrollReminder() {
  ...
  return (
    ...
    >
      <span className="group-hover:text-[#FF5722] transition-colors pl-[2.4px]">SCROLL</span>
